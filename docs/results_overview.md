...
normalization methods. It includes the outputs of RFE-SVM, Bit-Flip
local search, and all classifier performance tables.
...
with the **7-feature subset** performing best and the Bit-Flip refinement finding
...
The figures below summarize Recall, G-Mean, and AUC across all feature subsets
...
# 3. Full Numerical Results

All values are percentages (%).  
Each section reports the results for a given feature subset and normalization
method across NORS, SMOTE, and CBUTE.

---

# 3.1 Three Features (Min–Max Normalization)
...
# 3.2 Three Features (Z-Score Normalization)
...
# 3.3 Five Features (Min–Max Normalization)
...
# 3.4 Five Features (Z-Score Normalization)
...
# 3.5 Seven Features (Min–Max Normalization)
...
# 3.6 Seven Features (Z-Score Normalization)
...
# 3.7 Best Features (Min–Max Normalization)
...
# 3.8 Best Features (Z-Score Normalization)
